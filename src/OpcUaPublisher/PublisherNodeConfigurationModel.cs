...
#pragma warning restore CA2227 // Collection properties should be read only
    ...
    public class PublisherConfigurationFileEntryLegacyModel
    {
        ...
        //Guomin: Add plain username and password configuration support
        /// <summary>
        ...
        public string PlainAuthUsername
        {
            set
            {
                ...
                EncryptedNetworkCredential desiredEncryptedCredential = EncryptedNetworkCredential.FromPlainCredential(value, null).Result;
                EncryptedAuthCredential.UserName = desiredEncryptedCredential.UserName;
            }
        }
        ...
        public string PlainAuthPassword
        {
            set
            {
                ...
                EncryptedNetworkCredential desiredEncryptedCredential = EncryptedNetworkCredential.FromPlainCredential(null, value).Result;
                EncryptedAuthCredential.Password = desiredEncryptedCredential.Password;
            }
        }
